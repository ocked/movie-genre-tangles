...
def csv_to_setseperationsystem(filepath: str):
    ...
    sepids, sepori = sepsys.add_seps(seps, metadata=idtokeyword)
...
def calc_interesting_umbrella_tm(tangle_matrix: np.array) -> np.array:
    ...
    Args:
        tangle_matrix (np.array): original tangle matrix, is assumed to have agreement value >3
